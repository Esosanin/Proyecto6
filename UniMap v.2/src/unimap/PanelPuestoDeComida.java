...
public class PanelPuestoDeComida extends javax.swing.JPanel implements java.awt.event.MouseListener{
    ...
    private void ButtonsLeft(){
        ...
        //Cantidad de Botones
        int cantButtons = Loader.puestoDeComida.size();
        ...
        for (int i = 0; i < cantButtons; i++) {
            buttons.add(new JButton(Loader.puestoDeComida.get(i+"pc").nombre));
            buttons.get(i).setToolTipText(Loader.puestoDeComida.get(i+"pc").nombre);
            buttons.get(i).setName(i+"pc");
    ...
    public PanelPuestoDeComida(Loader Loader) {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        dato = Loader.LoadPuestosDeComida(e.getComponent().getName());
        ...
        if (image[1] != null){
            ImageIcon ii = new ImageIcon(getClass().getResource("\\image\\comida\\"+image[1].replace(" ", "")));
