...
public class ventana extends javax.swing.JFrame {
    ...
    private void iniciar() {
        ...
        Label.setIcon(new ImageIcon(getClass().getResource("/image/iconos/spalsh.png")));
        Label.validate();
        Label.repaint();
    ...
    private void initComponents() {
        ...
        Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/iconos/spalsh.png"))); // NOI18N
