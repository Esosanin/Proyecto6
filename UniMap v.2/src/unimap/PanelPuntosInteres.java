...
public class PanelPuntosInteres extends javax.swing.JPanel implements java.awt.event.MouseListener{
    ...
    private void ButtonsLeft(){
        ...
        //Cantidad de Botones
        int cantButtons = Loader.areaRecreativa.size();
        ...
        for (int i = 0; i < cantButtons; i++) {
            buttons.add(new JButton(Loader.areaRecreativa.get(i+"pint").nombre));
            buttons.get(i).setToolTipText(Loader.areaRecreativa.get(i+"pint").nombre);
            buttons.get(i).setName(i+"pint");
    ...
    public PanelPuntosInteres(Loader Loader) {
        ...
        Split_pi.setDividerSize(0);
        SplitVista.setDividerSize(0);
        SplitDescrip.setDividerSize(0);
        Split_pi.setOneTouchExpandable(false);
    ...
    private void initComponents() {
        ...
        Split_pi = new javax.swing.JSplitPane();
        ...
        Split_pi.setDividerLocation(145);
        Split_pi.setMaximumSize(new java.awt.Dimension(879, 768));
        Split_pi.setMinimumSize(new java.awt.Dimension(879, 768));
        Split_pi.setPreferredSize(new java.awt.Dimension(879, 768));
        ...
        Split_pi.setRightComponent(SplitVista);
        ...
        Split_pi.setLeftComponent(Pbuttons);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(Split_pi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        dato = Loader.LoadAreasReacreativas(e.getComponent().getName());
        ...
        if (image[1] != null){
            ImageIcon ii = new ImageIcon(getClass().getResource("\\image\\pint\\"+image[1].replace(" ", "")));
    ...
    private javax.swing.JSplitPane Split_pi;
