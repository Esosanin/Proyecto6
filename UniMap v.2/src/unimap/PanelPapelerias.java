...
public class PanelPapelerias extends javax.swing.JPanel implements java.awt.event.MouseListener{
    ...
    private void ButtonsLeft(){
        ...
        //Cantidad de Botones
        int cantButtons = Loader.papeleria.size();
        ...
        for (int i = 0; i < cantButtons; i++) {
            buttons.add(new JButton(Loader.papeleria.get(i+"pp").nombre));
            buttons.get(i).setToolTipText(Loader.papeleria.get(i+"pp").nombre);
            buttons.get(i).setName(i+"pp");
    ...
    public PanelPapelerias(Loader Loader) {
        ...
        Split_p.setDividerSize(0);
        SplitVista.setDividerSize(0);
        SplitDescrip.setDividerSize(0);
        Split_p.setOneTouchExpandable(false);
    ...
    private void initComponents() {
        ...
        Split_p = new javax.swing.JSplitPane();
        ...
        Split_p.setDividerLocation(145);
        Split_p.setMaximumSize(new java.awt.Dimension(879, 768));
        Split_p.setMinimumSize(new java.awt.Dimension(879, 768));
        Split_p.setPreferredSize(new java.awt.Dimension(879, 768));
        ...
        Split_p.setRightComponent(SplitVista);
        ...
        Split_p.setLeftComponent(Pbuttons);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(Split_p, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        dato = Loader.LoadPapelerias(e.getComponent().getName());
        ...
        if (image[1] != null){
            ImageIcon ii = new ImageIcon(getClass().getResource("\\image\\pp\\"+image[1].replace(" ", "")));
    ...
    private javax.swing.JSplitPane Split_p;
